...
import random
r = requests.post('http://localhost:3000/api/games/search', data={'devkey': "57e0162e3a96ff7428ecf4e5", 'username': 'darwinbot1'}) # search for new game
...
while output['state'] != 'complete':
	...
	r = requests.post('http://localhost:3000/api/games/submit/' + gameID, data={'playerID': playerID, 'move': possibleMoves[randomInt], 'devkey': "57e0162e3a96ff7428ecf4e5"}); # submit sample move
	json = r.json()
	print(json)
	output = json